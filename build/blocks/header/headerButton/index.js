...
/***/ "./src/blocks/header/headerButton/attributes.json":
/*!********************************************************!*\
  !*** ./src/blocks/header/headerButton/attributes.json ***!
  \********************************************************/
/***/ (function(module) {

module.exports = JSON.parse('{"text":{"type":"string","selector":"a","default":"Poptávka"},"href":{"type":"string","selector":"a","default":"#"},"type":{"type":"string","selector":"a","attribute":"type","default":"submit"},"bg_Color":{"type":"string","selector":"a","attribute":"background-color","default":"#af0b2b"},"text_Color":{"type":"string","selector":"a","attribute":"color","default":"#fff"},"border_Color":{"type":"string","selector":"a","attribute":"border-color","default":"#af0b2b"},"border_Width":{"type":"string","selector":"a","attribute":"border-width","default":"1px"}}');

/***/ }),

/***/ "./src/blocks/header/headerButton/block.json":
/*!***************************************************!*\
  !*** ./src/blocks/header/headerButton/block.json ***!
  \***************************************************/
/***/ (function(module) {

module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"mchymcak/headerbutton","title":"Ant Studio - Poptávka Tlačítko","icon":"button","example":{},"description":"Poptávka Tlačítko","category":"theme","supports":{"html":false},"textdomain":"ant-studio-example","editorScript":"file:./index.js","parent":["mchymcak/headerblock"]}');
...
!function() {
/*!*************************************************!*\
  !*** ./src/blocks/header/headerButton/index.js ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/header/headerButton/block.json");
/* harmony import */ var _attributes_json__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./attributes.json */ "./src/blocks/header/headerButton/attributes.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_7__.name, {
  ...
  edit: props => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
      ...
      attributes: attributes,
      setAttributes: setAttributes,
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Barva Pozadí', 'ant-studio-example'),
      target: "bg_Color",
      default: attributes.bg_Color
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_Divider__WEBPACK_IMPORTED_MODULE_6__["default"], null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_NewColorPalette__WEBPACK_IMPORTED_MODULE_5__["default"], {
      attributes: attributes,
      setAttributes: setAttributes,
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Barva Okrajů', 'ant-studio-example'),
      target: "border_Color",
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Tlouštka Okrajů', 'ant-studio-example'),
      ...
      initialOpen: false,
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Nastavení Odkazu', 'ant-studio-example')
